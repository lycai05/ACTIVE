  ...
  <n-card :content-style="{ padding: '10px' }" :header-style="{ padding: '10px' }" :segmented="true">
    <template #header>
      ...
      <template v-else>
        ...
        <n-statistic label="Cloud hosted datasets">
        664
      </n-statistic>
      </template>
    </template>
...
const init = () => {
  const option = {
    color: ['#6E6E6E', '#8C8C8C', '#AAAAAA', '#C8C8C8'] , // Define the custom colors for the pie slices
    grid: {
      left: '5%',
      right: '5%',
      top: '5%',
    ...
    series: [
      {
        ...
        data: [
          { value: 254, name: 'Chromatin loops' },
          { value: 254, name: '1D coverage' },
          { value: 254, name: 'Interaction heatmap' },
          { value: 1, name: 'Annotation files' },
          // { value: 1594, name: '电话' },
          // { value: 1347, name: '地推' },
          // { value: 635, name: '直播' },
        ],
