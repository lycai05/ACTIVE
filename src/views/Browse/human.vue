<template>
  ...
  <n-modal v-model:show="showAddTrackModal" preset="card" size="huge" header-class="bg-white" content-class="bg-white">
    ...
    <n-tabs type="line" animated>
      ...
      <n-tab-pane name="Add Single cell 3D track" tab="Single cell 3D track" display-directive="show">
        
      </n-tab-pane>
      <n-tab-pane name="Add Single molecular 3D track" tab="Single molecular 3D track" display-directive="show">
        
      </n-tab-pane>
    </n-tabs>
  </n-modal>

  <n-modal v-model:show="showTracksInfoModal" preset="card" style="max-width: 900px" header-class="bg-white" content-class="bg-white"
    size="huge">
