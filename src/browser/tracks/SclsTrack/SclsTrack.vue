...
<template>
  <div class="track-container">
    <scls-track-item  v-for="(view, index) in props.trackViews" :key="index" :location="view"
...
<script setup lang="ts">
import { defineProps } from 'vue'
import SclsTrackItem from './SclsTrackItem.vue'
...
let margin = '0 px';  // Default margin for middle items
