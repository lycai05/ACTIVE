...
var MyBlobBuilder = function() {
  ...
  MyBlobBuilder.prototype.getBlob = function() {
	...
	this.blob = new Blob(this.parts, { type: 'application/javascript' });
	}
	return this.blob;
  };
...
export default function workerQueue() {
	...
	this.dispatch = function() {
		...
		worker.postMessage(data,[data.args.offscreen]);
		// pause dispatching
		if (this.delay>0) {
			this.isWaiting = true;
	...
	this.getWorker = function() {
		...
		// bb.append();
		bb.append(["import * as d3 from 'd3';import { RemoteFile } from 'generic-filehandle';import { BigWig } from '@gmod/bbi';this.onmessage = "+onmessage.toString()])
		// var blob = new Blob(["this.onmessage = "+onmessage.toString()],{type: "text/javascript"});
		console.log(bb.parts)
		var blob = bb.getBlob();
		worker = new Worker(window.URL.createObjectURL(blob), {type: 'module'});
		// console.log(["this.onmessage = "+onmessage.toString()],{type: "text/javascript"})
