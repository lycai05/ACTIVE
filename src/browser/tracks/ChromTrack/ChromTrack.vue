<template>
  <div class="track-container">
    <chrom-track-item v-for="(view, index) in props.trackViews" :key="index" :location="view"
...
import ChromTrackItem from './ChromTrackItem.vue'
...
let margin = '0 5px';  // Default margin for middle items
