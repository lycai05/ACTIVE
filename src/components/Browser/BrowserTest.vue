<template>
  ...
  <!-- <ActiveBrowser
    :assembly="asm"
      :tracksInfo="tracksInfo"></ActiveBrowser> -->
    <VueActiveBrowser
      id="testID"
     :assembly="asm"
      :tracksInfo="tracksInfo"
    ...
    const tracksInfo = ref([
        {
            ...
            "areaOpacity": 0.1
              ...
              {
          id: 'GM12878-RNAPII-ChIA-PET-Block',
          name: 'GM12878 RNAPII ChIA PET Block',
          label: 'GM12878 RNAPII ChIA PET Block',
          type: 'PclsTrack',
          url: 'http://47.107.91.5/data//3D_loops/ENCFF040KUS_WashU.bed.gz',
          style: 'block'
        },
        ...
        type: 'HicTrack',
        url: 'http://47.107.91.5/data//3D_hic/ENCFF575CQS.hic',
        display: 'triangle'
      }
    ])
    onBeforeMount(() => {
...
onUnmounted(() => {
  console.log('Component has been unmounted!');
    ...
    <style>
    </style>../../../../active-browser/dist/active-browser.es